...
---
# <a name="create-an-azure-service-principal-with-azure-powershell"></a><span data-ttu-id="8c022-104">Vytvoření instančního objektu Azure s použitím prostředí Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="8c022-104">Create an Azure service principal with Azure PowerShell</span></span>
...
## <a name="what-is-a-service-principal"></a><span data-ttu-id="8c022-109">Co je instanční objekt?</span><span class="sxs-lookup"><span data-stu-id="8c022-109">What is a 'service principal'?</span></span>
...
## <a name="verify-your-own-permission-level"></a><span data-ttu-id="8c022-114">Ověření vlastní úrovně oprávnění</span><span class="sxs-lookup"><span data-stu-id="8c022-114">Verify your own permission level</span></span>
...
## <a name="create-a-service-principal-for-your-app"></a><span data-ttu-id="8c022-119">Vytvoření instančního objektu pro aplikaci</span><span class="sxs-lookup"><span data-stu-id="8c022-119">Create a service principal for your app</span></span>
...
* <span data-ttu-id="8c022-122">Jedinečný název nasazené aplikace, například název MyDemoWebApp používaný v následujících příkladech, nebo:</span><span class="sxs-lookup"><span data-stu-id="8c022-122">The unique name of your deployed app, such as "MyDemoWebApp" in the following examples, or</span></span>
...
### <a name="get-information-about-your-application"></a><span data-ttu-id="8c022-124">Získání informací o aplikaci</span><span class="sxs-lookup"><span data-stu-id="8c022-124">Get information about your application</span></span>
...
### <a name="create-a-service-principal-for-your-application"></a><span data-ttu-id="8c022-126">Vytvoření instančního objektu pro aplikaci</span><span class="sxs-lookup"><span data-stu-id="8c022-126">Create a service principal for your application</span></span>
...
### <a name="get-information-about-the-service-principal"></a><span data-ttu-id="8c022-128">Získání informací o instančním objektu</span><span class="sxs-lookup"><span data-stu-id="8c022-128">Get information about the service principal</span></span>
...
### <a name="sign-in-using-the-service-principal"></a><span data-ttu-id="8c022-129">Přihlášení pomocí instančního objektu</span><span class="sxs-lookup"><span data-stu-id="8c022-129">Sign in using the service principal</span></span>
...
<span data-ttu-id="8c022-150">V tomto příkladu přidáme do předchozího příkladu roli **Čtenář** a odstraníme roli **Přispěvatel**:</span><span class="sxs-lookup"><span data-stu-id="8c022-150">In this example, we add the **Reader** role to our prior example, and delete the **Contributor** one:</span></span>
...
## <a name="change-the-credentials-of-the-security-principal"></a><span data-ttu-id="8c022-157">Změna přihlašovacích údajů objektu zabezpečení</span><span class="sxs-lookup"><span data-stu-id="8c022-157">Change the credentials of the security principal</span></span>
...
### <a name="add-a-new-password-for-the-service-principal"></a><span data-ttu-id="8c022-161">Přidání nového hesla pro instanční objekt</span><span class="sxs-lookup"><span data-stu-id="8c022-161">Add a new password for the service principal</span></span>
...
### <a name="get-a-list-of-credentials-for-the-service-principal"></a><span data-ttu-id="8c022-162">Získání seznamu přihlašovacích údajů pro instanční objekt</span><span class="sxs-lookup"><span data-stu-id="8c022-162">Get a list of credentials for the service principal</span></span>
...
### <a name="remove-the-old-password-from-the-service-principal"></a><span data-ttu-id="8c022-163">Odebrání předchozího hesla z instančního objektu</span><span class="sxs-lookup"><span data-stu-id="8c022-163">Remove the old password from the service principal</span></span>
...
### <a name="verify-the-list-of-credentials-for-the-service-principal"></a><span data-ttu-id="8c022-164">Ověření seznamu přihlašovacích údajů pro instanční objekt</span><span class="sxs-lookup"><span data-stu-id="8c022-164">Verify the list of credentials for the service principal</span></span>
