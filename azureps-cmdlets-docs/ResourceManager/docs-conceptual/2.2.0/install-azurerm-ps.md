...
### <a id="update-azps"></a><span data-ttu-id="39891-149">Aktualizace na novou verzi Azure PowerShellu</span><span class="sxs-lookup"><span data-stu-id="39891-149">Updating to a new version of Azure PowerShell</span></span>
